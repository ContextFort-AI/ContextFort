            ...
            (i = !0),
                ...
                requestAnimationFrame(() => {
                    if ((e && (e.style.opacity = "1"), n)) {
                        ...
                        e && ((e.style.transform = "translateY(0)"), (e.style.opacity = "1"));
                    }
                });
        }
        function c() {
            if (i) {
                if (((i = !1), e && (e.style.opacity = "0"), n)) {
                    const e = n.querySelector("#claude-agent-stop-button");
                    e && ((e.style.transform = "translateY(100px)"), (e.style.opacity = "0"));
                }
                setTimeout(() => {
                    i ||
            ...
            (a = !0),
                t
                    ...
                    : ((t = (function () {
                          ...
                          n &&
                              (n.addEventListener("mouseenter", () => {
                                  (n.style.background = "#F0EEE6"), t && (t.style.opacity = "1");
                              }),
                              n.addEventListener("mouseleave", () => {
                                  (n.style.background = "transparent"), t && (t.style.opacity = "0");
                              }),
                              n.addEventListener("click", async () => {
                                  try {
                          ...
                          return (
                              i &&
                                  (i.addEventListener("mouseenter", () => {
                                      (i.style.background = "#F0EEE6"), a && (a.style.opacity = "1");
                                  }),
                                  i.addEventListener("mouseleave", () => {
                                      (i.style.background = "transparent"), a && (a.style.opacity = "0");
                                  }),
                ...
                (l = setInterval(async () => {
                    try {
                        const e = await chrome.runtime.sendMessage({ type: "STATIC_INDICATOR_HEARTBEAT" });
                        e?.success || L();
                    } catch (e) {
                        L();
                    }
                ...
                : "HIDE_AGENT_INDICATORS" === l.type
                  ...
                  : "HIDE_FOR_TOOL_USE" === l.type
                    ...
                    : "SHOW_AFTER_TOOL_USE" === l.type
                      ? (s && (e && (e.style.display = ""), n && (n.style.display = "")),
                        o && t && (t.style.display = ""),
                        (s = !1),
                        (o = !1),
                        y({ success: !0 }))
                      : "SHOW_STATIC_INDICATOR" === l.type
                        ? (d(), y({ success: !0 }))
                        : "HIDE_STATIC_INDICATOR" === l.type && (L(), y({ success: !0 }));
        }),
